...
public abstract class UIRect : MonoBehaviour
{
	...
	public virtual Vector3[] GetSides(Transform relativeTo)
	{
		if (this.anchorCamera != null)
		{
			return this.mCam.GetSides(this.cameraRayDistance, relativeTo, this.mShowInSafeArea);
		}
	...
	public class AnchorPoint
	{
		...
		public Vector3[] GetSides(Transform relativeTo)
		{
			if (this.target != null)
			{
				...
				{
					return this.target.GetComponent<Camera>().GetSides(relativeTo, this.rect.mShowInSafeArea);
				}
			}
			return null;
		}

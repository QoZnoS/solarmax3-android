...
public class UICamera : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		if (UICamera.cache0 == null)
		{
			UICamera.cache0 = new BetterList<UICamera>.CompareFunc(UICamera.CompareFunc);
		}
		betterList.Sort(UICamera.cache0);
	}
	...
	[CompilerGenerated]
	private static BetterList<UICamera>.CompareFunc cache0;

...
public class UIWidget : UIRect
{
	...
	public void ManualScale(int px)
	{
		...
		int num = (this.defaultWidth <= this.defaultHeight) ? this.defaultHeight : this.defaultWidth;
		float num2 = 1f - (float)px * 1f / (float)num;
		this.width = Mathf.RoundToInt((float)this.defaultWidth * num2);
		this.height = Mathf.RoundToInt((float)this.defaultHeight * num2);
	}

...
public class UIAnchor : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else if (uipanel != null)
		{
			...
			{
				if (uipanel.mShowInSafeArea)
				{
					float num = (!(this.mRoot != null)) ? 0.5f : ((float)this.mRoot.activeHeight / NGUITools.SafeArea.height * 0.5f);
					this.mRect.xMin = -NGUITools.SafeArea.width * num * NGUITools.Simulate_iPhoneXScale;
					this.mRect.yMin = -NGUITools.SafeArea.height * num;

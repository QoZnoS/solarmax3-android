...
{
	[ProtoContract(Name = "SCGainTimerChest")]
	[Serializable]
	public class SCGainTimerChest : IExtensible
	{
		...
		[ProtoMember(2, IsRequired = false, Name = "time_out", DataFormat = DataFormat.TwosComplement)]
		[DefaultValue(0L)]

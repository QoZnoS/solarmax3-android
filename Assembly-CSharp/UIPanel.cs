...
public class UIPanel : UIRect
{
	...
	public int depth
	{
		...
		set
		{
			if (this.mDepth != value)
			{
				...
				if (UIPanel.cache0 == null)
				{
					UIPanel.cache0 = new Comparison<UIPanel>(UIPanel.CompareFunc);
				}
				list.Sort(UIPanel.cache0);
			}
		}
	}
	...
	protected override void OnInit()
	{
		...
		List<UIPanel> list = UIPanel.list;
		if (UIPanel.cache1 == null)
		{
			UIPanel.cache1 = new Comparison<UIPanel>(UIPanel.CompareFunc);
		}
		list.Sort(UIPanel.cache1);
	}
	...
	public void SortWidgets()
	{
		...
		if (UIPanel.cache2 == null)
		{
			UIPanel.cache2 = new Comparison<UIWidget>(UIWidget.PanelCompareFunc);
		}
		list.Sort(UIPanel.cache2);
	}
	...
	[CompilerGenerated]
	private static Comparison<UIPanel> cache0;

	[CompilerGenerated]
	private static Comparison<UIPanel> cache1;

	[CompilerGenerated]
	private static Comparison<UIWidget> cache2;

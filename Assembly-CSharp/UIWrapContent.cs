...
public class UIWrapContent : MonoBehaviour
{
	...
	public virtual void SortBasedOnScrollMovement()
	{
		...
		if (this.mHorizontal)
		{
			...
			if (UIWrapContent.cache0 == null)
			{
				UIWrapContent.cache0 = new Comparison<Transform>(UIGrid.SortHorizontal);
			}
			list.Sort(UIWrapContent.cache0);
		}
		else
		{
			List<Transform> list2 = this.mChildren;
			if (UIWrapContent.cache1 == null)
			{
				UIWrapContent.cache1 = new Comparison<Transform>(UIGrid.SortVertical);
			}
			list2.Sort(UIWrapContent.cache1);
		}
	...
	public virtual void SortAlphabetically()
	{
		...
		List<Transform> list = this.mChildren;
		if (UIWrapContent.cache2 == null)
		{
			UIWrapContent.cache2 = new Comparison<Transform>(UIGrid.SortByName);
		}
		list.Sort(UIWrapContent.cache2);
		this.ResetChildPositions();
	}

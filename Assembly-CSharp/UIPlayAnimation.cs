...
public class UIPlayAnimation : MonoBehaviour
{
	...
	private void OnHover(bool isOver)
	{
		...
		{
			this.Play(isOver, this.dualState, 1f, false);
		}
	}
	...
	private void OnPress(bool isPressed)
	{
		...
		{
			this.Play(isPressed, this.dualState, 1f, false);
		}
	}
	...
	private void OnSelect(bool isSelected)
	{
		...
		{
			this.Play(isSelected, this.dualState, 1f, false);
		}
	}
	...
	private void OnToggle()
	{
		...
		{
			this.Play(UIToggle.current.value, this.dualState, 1f, false);
		}
	}
	...
	{
		this.Play(forward, true, 1f, false);
	}
	...
	public void Play(bool forward, bool onlyIfDifferent, float speed = 1f, bool bLoop = false)
	{

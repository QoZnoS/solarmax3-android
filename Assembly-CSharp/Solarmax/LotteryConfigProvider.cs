...
namespace Solarmax
{
	public class LotteryConfigProvider : Singleton<LotteryConfigProvider>, IDataProvider
	{
		public bool IsXML()
		{
			return true;
		...
		public void Load()
		{
			...
			{
				Singleton<LoggerSystem>.Instance.Error("data/Lottery.xml resource failed " + ex.ToString(), new object[0]);
			}
		}

...
namespace Solarmax
{
	public class LevelConfigConfigProvider : Solarmax.Singleton<LevelConfigConfigProvider>, IDataProvider
	{
		public string Path()
		{
		...
		public void Load()
		{
			...
			{
                Solarmax.Singleton<LoggerSystem>.Instance.Error("data/Level.xml resource failed " + ex.ToString(), new object[0]);
			}
		}

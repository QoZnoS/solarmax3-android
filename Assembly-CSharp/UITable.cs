...
public class UITable : UIWidgetContainer
{
	...
	public List<Transform> GetChildList()
	{
		...
		if (this.sorting != UITable.Sorting.None)
		{
			if (this.sorting == UITable.Sorting.Alphabetic)
			{
				...
				if (UITable.cache0 == null)
				{
					UITable.cache0 = new Comparison<Transform>(UIGrid.SortByName);
				}
				list2.Sort(UITable.cache0);
			}
			else if (this.sorting == UITable.Sorting.Horizontal)
			{
				List<Transform> list3 = list;
				if (UITable.cache1 == null)
				{
					UITable.cache1 = new Comparison<Transform>(UIGrid.SortHorizontal);
				}
				list3.Sort(UITable.cache1);
			}
			else if (this.sorting == UITable.Sorting.Vertical)
			{
				List<Transform> list4 = list;
				if (UITable.cache2 == null)
				{
					UITable.cache2 = new Comparison<Transform>(UIGrid.SortVertical);
				}
				list4.Sort(UITable.cache2);
			}
	...
	{
		if (UITable.cache3 == null)
		{
			UITable.cache3 = new Comparison<Transform>(UIGrid.SortByName);
		}
		list.Sort(UITable.cache3);
	}
	...
	[CompilerGenerated]
	private static Comparison<Transform> cache1;

	[CompilerGenerated]
	private static Comparison<Transform> cache2;

	[CompilerGenerated]
	private static Comparison<Transform> cache3;

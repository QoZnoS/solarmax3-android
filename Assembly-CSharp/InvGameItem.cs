...
public class InvGameItem
{
	...
	public List<InvStat> CalculateStats()
	{
		...
		if (this.baseItem != null)
		{
			...
			if (InvGameItem.cache0 == null)
			{
				InvGameItem.cache0 = new Comparison<InvStat>(InvStat.CompareArmor);
			}
			list2.Sort(InvGameItem.cache0);
		}
		return list;
	}
	...
	[CompilerGenerated]
	private static Comparison<InvStat> cache0;
